...
public class Patterns {
 ...
 static void satyam(int number){
    ...
    /*    for (int i = 0; i < 4; i++) { // this outer loop will print 4 rows
            for (int j = 0; j < 10; j++) { // this inner loop will print 10 star in one row
                System.out.print("*");
            }
            System.out.println();
        }
...
*/ 
    ...
    /*     for ( int i =7;i>0;i--){ // this will print 7 row in increasing to decreasing format
            for ( int j=0;j<i;j++){ // this is responsible for printing star according to the current i values 
                System.out.print("*");
